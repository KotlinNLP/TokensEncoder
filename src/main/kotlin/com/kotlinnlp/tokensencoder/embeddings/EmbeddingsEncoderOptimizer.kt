...
/**
 * The optimizer of the [EmbeddingsEncoder].
 *
...
class EmbeddingsEncoderOptimizer(
   ...
   */
  private val embeddingsOptimizer = EmbeddingsOptimizer(this.model.embeddingsMap, this.updateMethod)
  ...
  override fun accumulate(paramsErrors: TokensEncoderParameters, copy: Boolean) {
    ...
    paramsErrors as EmbeddingsEncoderParams
